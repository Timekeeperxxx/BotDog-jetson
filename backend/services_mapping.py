...
START_MAPPING_SCRIPT = PROJECT_ROOT / "scripts/start_mapping.sh"
VIDEO_PIPELINE_SCRIPT = PROJECT_ROOT / "scripts/run-pipeline.sh"
VIDEO_PIPELINE_PID_FILES = (
    PROJECT_ROOT / "logs/mediamtx.pid",
    PROJECT_ROOT / "logs/ffmpeg_cam1.pid",
    PROJECT_ROOT / "logs/ffmpeg_cam2.pid",
    PROJECT_ROOT / "logs/ffmpeg_cam3.pid",
    PROJECT_ROOT / "logs/ffmpeg_cam4.pid",
)
